    ...
    <div id="home" className="bg-slate-100 py-24 ">
      <div className=" mx-auto px-8 flex flex-col-reverse items-center gap-9 lg:flex  lg:flex-row lg:items-center   lg:justify-between lg:mx-auto lg:max-w-6xl lg:gap-16 ">
        <article className="text-center">
          ...
          <h1 className="text-4xl  font-bold tracking-wide text-slate-700 lg:text-5xl  ">
            I’m Victor Sunny
          </h1>
          <p className=" font-mono text-base tracking-wide text-slate-600 mt-2 mb-3.5 md:max-w-2xl md:mb-6 lg:max-w-4xl lg:text-xl lg:text-slate-400 lg:tracking-wide lg:leading-10 lg:mt-7 lg:mb-7 ">
